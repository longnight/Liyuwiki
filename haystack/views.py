...
# from main.settings import the_cache
...
class SearchView(object):
    ...
    def get_query(self):
        ...
        if self.form.is_valid():
            ...
            if self.form.cleaned_data['q'] and not self.form.cleaned_data['q'].isspace():
                if self.form.cleaned_data['q'] in recent_kw:
                    recent_kw.remove(self.form.cleaned_data['q'])
                recent_kw.appendleft(self.form.cleaned_data['q'])
                the_cache.set('recent_kw', recent_kw)
